...
42. Make a click-the-word item (hot-text): "Read the dictionary entry … Click the word in the passage that matches this definition." The correct word is the outcome's `focus` (with line/quote for the excerpt); the distractor candidate words `targets` the outcome.
